...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  ?>
    ...
    <li class="nav-item">
      <a class="nav-link " href="updateSalary.php">
...
<?php } ?>
  ...
  <main id="main" class="main">
    ...
    <br><br><br><br>
        <div class="pagetitle">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 mt-3">Update Salary</h1>
          </div><br>
    ...
    <form action="updateSalary.php" method = "GET">
       <!-- Date input -->
       <?php
   
   include('config/conn.php');
   date_default_timezone_set('Asia/Kolkata');
   $sql ="SELECT name FROM employee_details";
...
if ($n != 0) {
   ...
   echo '<div class="row"><div class="col-md-6"><select class="form-select" id="name" name="name" aria-label="Gender" required>';
   echo '<option value="" selected disabled>-- Choose Employee --</option>';
...
mysqli_close($connect);
   ?> 
  <div class="col-md-6"> <button type="submit" class="btn btn-primary">Get info</button></div></form>
     </form>
     <!-- Form code ends --> 
...
<div class="container p-4" style="overflow:auto">
                  ...
                  <br>
                    <form name="SumForm"  method="post" action="update_salary.php">
...
include('config/conn.php');
    ...
    <div class="col">
      ...
      <label class="form-label" for="form6Example1">Current Salary</label>
        <input type="number" id="form6Example1" value ="" class="form-control" disabled/>
       
      </div>
    </div>
    <div class="col">
      <div class="form-outline">
      <label class="form-label" for="form6Example2">New Salary</label>
        <input type="number" id="npay" name ="npay" class="form-control" />
       
      </div>
    </div>
    <div class="col">
      <div class="form-outline">
      <label class="form-label" for="form6Example2">Effective Date</label>
  ...
  <input type="hidden" value="" class="form-control">';
                   ...
                   $s ="SELECT * FROM employee_details WHERE name='$emp'";
                   $res = $connect->query($s);
                   if($res !== false)
                   {
    ...
    <div class="col">
      <div class="form-outline">
      <label class="form-label" for="form6Example1">Current Salary</label>
        <input type="number" id="form6Example1" value ="'.$row['salary'].'" class="form-control" disabled/>
  ...
  <input type="hidden" value="'.$row['e_id'].'" name="id" class="form-control">';
}}    
                ?>
  ...
  <center><button type="submit" class="btn btn-primary"  style ="background-color: #333d97;" onclick="showSuccessAlert()" id="success" name="success">Update</button>
