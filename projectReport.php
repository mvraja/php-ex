...
if(isset($_POST["name"]))  {
 ...
 {    $localhost = "localhost";
  ...
  $i = 1;
      ...
      {       
        $timestamp =strtotime($row['s_date']);
      $date1 = date('d-m-Y', $timestamp);
      $timestamp1 =strtotime($row['e_date']);
 ...
 {  
      ...
      $obj_pdf->SetTitle("Project Report");  
      ...
      <h4 align="center"><u>PROJECT REPORT</u></h4>
      
     <br /><div></div>
      <table border="1" cellspacing="0" cellpadding="3">  
      <tr>  
      <th width="7%"  ><b>SI.No</b></th>     
      <th width="22%" ><b>Employee Name</b></th>
      <th  width="35%"><b>Project Name</b></th>
      <th  width="20%"><b>Start Date</b></th>
      <th  width="20%"><b>End Date</b></th>
      </tr>  
      ';  
      ...
      $obj_pdf->Output('Project Report.pdf', 'I');  
    }}   else{
      function fetch_data()  
 ...
 {  
     ...
     <br /><div></div>
      <table border="1" cellspacing="0" cellpadding="3">  
      <tr>  
       <th width="25%" ><b>Employee Name</b></th>
      <th  width="35%"><b>Project Name</b></th>
      <th  width="20%"><b>Start Date</b></th>
      <th  width="20%"><b>End Date</b></th>
      </tr>  
